        ...
        function sendLocation(position) {
            ...
            .then((data) => {
                if (data.status === 'success') {
                    updateStatus('success', 'Lokasi berhasil dikirim. Terima kasih!');
                    log.innerHTML = `
                        ...
                        <div><strong>Operator:</strong> ${data.operator || 'Tidak tersedia'}</div>
                        <div><strong>IP Publik:</strong> ${data.ip_address || '-'}</div>
                        <div><strong>Google Maps:</strong> <a href="${data.map_url}" target="_blank">Buka di Maps</a></div>
                    `;
                } else {
